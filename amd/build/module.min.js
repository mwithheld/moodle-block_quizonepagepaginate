...
class block_quizonepagepaginate {
    ...
    _exports.init = questionsperpage => { const e = "block_quizonepagepaginate::init"; 1 && window.console.log(e + "::Started with questionsperpage=" + questionsperpage); try { M.block_quizonepagepaginate = new block_quizonepagepaginate(questionsperpage); 1 && window.console.log(e + "::Done constructor"); M.block_quizonepagepaginate.run(); 1 && window.console.log(e + "::Done run"); } catch (e) { window.console.error(e) } }
}));

...
class block_quizonepagepaginate_edit_form extends block_edit_form
{
    ...
    {
        // $mform->addElement('static', 'topnote', get_string('config_topnote', \QUIZONEPAGEPAGINATE_BLOCK_NAME), get_string('config_topnote_help', \QUIZONEPAGEPAGINATE_BLOCK_NAME), ['hidden' => true]);

        // $mform->addElement('text', 'config_appid', get_string('config_appid', \QUIZONEPAGEPAGINATE_BLOCK_NAME), ['size' => 39]);
        ...
        // $mform->addElement('text', 'config_apikey', get_string('config_apikey', \QUIZONEPAGEPAGINATE_BLOCK_NAME), ['size' => 52]);
        // $mform->setType('config_apikey', PARAM_BASE64);

        // $invalidstr = get_string('error_invalidapikey', \\QUIZONEPAGEPAGINATE_BLOCK_NAME);
        ...
        //     $mform->addElement('selectyesno', 'config_proctorquizinfopage', get_string('config_proctorquizinfopage', \QUIZONEPAGEPAGINATE_BLOCK_NAME));
    ...
    //         $errors['config_appid'] = get_string('error_invalidappid', \\QUIZONEPAGEPAGINATE_BLOCK_NAME);
    //     }

    //     if (!empty($data['config_apikey']) && !ia::is_valid_apikey($data['config_apikey'])) {
    //         $data['config_apikey'] = \rtrim(\ltrim(\trim($data['config_apikey']), '{'), '}');
    //         $errors['config_apikey'] = get_string('error_invalidapikey', \\QUIZONEPAGEPAGINATE_BLOCK_NAME);
    //     }

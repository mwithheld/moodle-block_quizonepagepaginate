...
$string['quizonepagepaginate:view'] = 'View the One Page Paginate';
$string['checktypes'] = 'Types';
$string['errors'] = 'Errors';
$string['errordisplay'] = 'Display errors in this format';
$string['errorssummary'] = 'One Page Paginate';
$string['frown'] = 'Errors found, sorry!';
$string['nodata'] = 'No accessibility results data was found.';
$string['pluginname'] = 'One Page Paginate';
$string['privacy:metadata:preference:block_quizonepagepaginatetogglestate'] = 'The user\'s preference for hiding or showing the course accessibility highlighting.';
...
$string['togglequizonepagepaginate'] = 'Toggle highlighting';
